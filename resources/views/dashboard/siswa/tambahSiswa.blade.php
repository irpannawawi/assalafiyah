                    ...
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <div class="page-header-title">
                                <h5 class="m-b-10"><i class="fa fa-group"></i> Data Siswa</h5>
                        ...
                        <div class="col-md-4">
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="/tambahSiswa">Tambah Data Siswa</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="card col-12">
                                    <div class="card-header">
                                        <h5>Tabah Data Siswa</h5>
                                    </div>
                                    <div class="card-block">

                                            <form action="/tambahDataSiswa" method="POST" enctype="multipart">
                                                @csrf
