                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-block">
                                            ...
                                            <form action="/update_data_siswa/{{ $data->id }}" method="POST">
                                                @csrf
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select name="jenjang_pendidikan" class="form-control">
                                                            <option selected>{{ $data->jenjang_pendidikan }}</option>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select name="ukuran_seragam" class="form-control">
                                                            <option selected>{{ $data->ukuran_seragam }}</option>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input name="asal_sekolah" type="text" class="form-control" value="{{ $data->asal_sekolah }}">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">No SKHUN</label>
                                                    <div class="col-sm-10">
                                                        <input name="no_skhun" type="text" class="form-control"value="{{ $data->no_skhun }}">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">No NISN</label>
                                                    <div class="col-sm-10">
                                                        <input name="no_nisn" type="text" class="form-control"value="{{ $data->no_nisn }}">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">No Ujian Nasional</label>
                                                    <div class="col-sm-10">
                                                        <input name="no_un" type="text" class="form-control"value="{{ $data->no_un }}">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">No Ijazah</label>
                                                    <div class="col-sm-10">
                                                        <input name="no_ijazah" type="text" class="form-control"value="{{ $data->no_ijazah }}">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input name="anakke" type="text" class="form-control"value="{{ $data->anakke }}">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input name="jmlh_saudara" type="text" class="form-control"value="{{ $data->jmlh_saudara }}">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">No. KK</label>
                                                    <div class="col-sm-10">
                                                        <input name="no_kk" type="text" class="form-control"value="{{ $data->no_kk }}">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">Nama Ayah</label>
                                                    <div class="col-sm-10">
                                                        <input name="nama_ayah" type="text" class="form-control"value="{{ $data->nama_ayah }}">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">Nama Ibu</label>
                                                    <div class="col-sm-10">
                                                        <input name="nama_ibu" type="text" class="form-control"value="{{ $data->nama_ibu }}">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">NIK Ayah</label>
                                                    <div class="col-sm-10">
                                                        <input name="nik_ayah" type="text" class="form-control"value="{{ $data->nik_ayah }}">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">NIK Ibu</label>
                                                    <div class="col-sm-10">
                                                        <input name="nik_ibu" type="text" class="form-control"value="{{ $data->nik_ibu }}">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">Tempat lahir Ayah</label>
                                                    <div class="col-sm-10">
                                                        <input name="tl_ayah" type="text" class="form-control"value="{{ $data->tl_ayah }}">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">Tempat lahir Ibu</label>
                                                    <div class="col-sm-10">
                                                        <input name="tl_ibu" type="text" class="form-control"value="{{ $data->tl_ibu }}">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">Tanggal lahir Ayah</label>
                                                    <div class="col-sm-10">
                                                        <input name="tgl_ayah" type="text" class="form-control"value="{{ $data->tgl_ayah }}">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">Tanggal lahir Ibu</label>
                                                    <div class="col-sm-10">
                                                        <input name="tgl_ibu" type="text" class="form-control"value="{{ $data->tgl_ibu }}">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">Pekerjaan Ayah</label>
                                                    <div class="col-sm-10">
                                                        <input name="pekerjaan_ayah" type="text" class="form-control"value="{{ $data->pekerjaan_ayah }}">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">Pekerjaan Ibu</label>
                                                    <div class="col-sm-10">
                                                        <input name="pekerjaan_ibu" type="text" class="form-control"value="{{ $data->pekerjaan_ibu }}">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">No. Telp Ayah</label>
                                                    <div class="col-sm-10">
                                                        <input name="no_hp_ayah" type="text" class="form-control"value="{{ $data->no_hp_ayah }}">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">No. Telp Ibu</label>
                                                    <div class="col-sm-10">
                                                        <input name="no_hp_ibu" type="text" class="form-control"value="{{ $data->no_hp_ibu }}">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select name="penghasilan_ayah" class="form-control">
                                                            <option selected>{{ $data->penghasilan_ayah }}</option>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select name="penghasilan_ibu" class="form-control">
                                                            <option selected>{{ $data->penghasilan_ibu }}</option>
                                                            <option value="Kurang dari Rp 500.000">Kurang dari Rp 500.000</option>
                                                            <option value="Rp 500.000 - Rp 999.999">Rp 500.000 - Rp 999.999</option>
                                                            <option value="Rp 1.000.000 - Rp 1.999.999">Rp 1.000.000 - Rp 1.999.999</option>
                                                            <option value="Rp 2.000.000 - Rp. 4.999.999">Rp 2.000.000 - Rp. 4.999.999</option>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select name="status_siswa" class="form-control">
                                                            <option selected>{{ $data->status_siswa }}</option>
