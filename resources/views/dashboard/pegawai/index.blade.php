                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-4">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="/dataPegawai">Data Pegawai</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="page-wrapper">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h5>Data Pegawai</h5>
                                    <span>Menampilkan list Pegawai</span>
                                </div>
                                <div class="card-block table-border-style"  style="min-height: 740px">
                                    <div class="table-responsive">
                                        <a href="tambahPegawai" class="btn btn-primary btn-sm waves-effect waves-light mb-2"><i class="fa fa-plus"></i>Tambah Pegawai</a>
                                        ...
                                        <table class="table table-bordered table-striped">
                                            <thead class="ark">
                                                <tr>
                                                    ...
                                                    <th style="text-align: center;"><i class="fa fa-sort"></i> <a style="border-radius: 30px;" class="mb-0" href="/dataPegawai?order=nama">Nama</a></th>
                                                    <th style="text-align: center;"><i class="fa fa-sort"></i> <a style="border-radius: 30px;" class="mb-0" href="/dataPegawai?order=nip">NIP</a></th>
                                                    <th style="text-align: center;"><i class="fa fa-sort"></i> <a style="border-radius: 30px;" class="mb-0" href="/dataPegawai?order=email">Email</a></th>
                                                    <th style="text-align: center;"><i class="fa fa-sort"></i><a style="border-radius: 30px;" class="mb-0 " href="/dataPegawai?order=mapel">Mata Pelajaran</a></th>
                                                    <th>Aksi</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                        ...
                                        <div class="btn-group m-3">
                                            <a href="/dataPegawai?page=" class="btn btn-sm btn-info">&lt;&lt;</a>
                                            <a href="/dataPegawai?page=" class="btn btn-sm btn-disabled" disabled>1</a>
                                            <a href="/dataPegawai?page=" class="btn btn-sm btn-info">2</a>
                                            <a href="/dataPegawai?page=" class="btn btn-sm btn-info">3</a>
                                            <a href="/dataPegawai?page=" class="btn btn-sm btn-info">4</a>
                                            <a href="/dataPegawai?page=" class="btn btn-sm btn-info">&gt;&gt;</a>
                                        </div>
                            </div>
